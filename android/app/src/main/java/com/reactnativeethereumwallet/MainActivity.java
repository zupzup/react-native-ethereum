...
//            Account newAcc = ks.newAccount("reallyhardpassword");
            ...
            android.util.Log.d("keyfile", newAcc.getAddres ).getHex());
            nh.setAcc(newAcc);
